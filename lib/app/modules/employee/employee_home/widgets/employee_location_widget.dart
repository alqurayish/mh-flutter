...
class EmployeeLocationWidget extends GetWidget<EmployeeHomeController> {
  ...
  Widget build(BuildContext context) {
    print('EmployeeLocationWidget.build: ${controller.showCheckInCheckOutWidget}');
    return Column(
      children: [
        Obx(() {
          if (controller.locationFetchError.value.isNotEmpty) {
            ...
            return Text('You have not been hired yet', style: MyColors.l111111_dwhite(context).semiBold16);
          }
        }),
